...
@section('content')
    ...
    <style>
        ...
        body {
            ...
            line-height: 1.8;
            max-width: 100%;
            /* direction: rtl; Forces right-to-left context globally */
        }
        ...
        .doc-title {
            text-align: center; /* Title stays centered as in standard forms */
            font-size: 1.8rem;
            font-weight: bold;
            margin-bottom: 40px;
        ...
        .doc-body {
            font-size: 1.15rem;
            text-align: right; /* Changed from justify to absolute right alignment */
            margin-bottom: 25px;
        }
...
<div class="document-container">
    ...
    <div class="profile-details">
        ...
        <div class="profile-item">§ المسجل بشعبة : {{$stagiaire->groupes[0]->nom_g}} </div>
