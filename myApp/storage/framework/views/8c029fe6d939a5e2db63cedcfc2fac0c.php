...
<div class="pv-container-wrapper">
    <button onclick="printCommitment('printSection')" class="btn btn-primary mb-3">
        <i class="bi bi-printer"></i> طباعة الالتزام
    </button>

    <div class="document-container" id="printSection">

        <div class="doc-date">فاس في : <?php echo e(date('Y/m/d')); ?></div>
        ...
        <div class="profile-details">
            <div class="profile-item">§ المتدرب(ة) : <?php echo e($fullName); ?></div>
            <div class="profile-item">§ المسجل بشعبة : <?php echo e($stagiaire->groupes[0]->nom_g ?? ''); ?></div>
            <div class="profile-item">§ الحامل لبطاقة التعريف الوطنية رقم : <?php echo e($stagiaire->cin); ?></div>
        </div>
...
<?php echo $__env->make('layout.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Desktop\DEV203\My_project_of_syntese\Gestion_Stagaiares\myApp\resources\views/documents/engagement.blade.php ENDPATH**/ ?>