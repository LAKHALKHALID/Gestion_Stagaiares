        ...
        <form action="<?php echo e(route('listAbsences.index')); ?>" method="get" class="my-4">
            <div class="row">
                <div class="col-md-5 d-flex gap-3">
                    ...
                    <input type="text" name="groupe" value="<?php echo e(request('groupe')); ?>" class="form-control" required>
                </div>
                <div class="col-md-5 d-flex gap-3">
            ...
            <div class="table-responsive">
                <table class="table table-bordered text-center align-middle ">
                    ...
                    <?php if($stagiaires != ''): ?>
                        ...
                        <form action="<?php echo e(route('listAbsences.store')); ?>" method="post">
                            <?php echo csrf_field(); ?>
                            <tbody>
                                <?php $__currentLoopData = $stagiaires; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $stagiaire): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    ?>
                                    <tr>
                                        <td class="text-start "><?php echo e(strtoupper($fullName)); ?></td>
                                        ...
                                        <?php for($i = 0; $i < 6; $i++): ?>
                                            ...
                                            ?>
                                            <input type="hidden"
                                        name="all_dates[<?php echo e($stagiaire->cef); ?>][]"
                                        value="<?php echo e($date); ?>">

                                            <td><input type="checkbox" value="8h30-11h00" 
                                                    name="absences[<?php echo e($stagiaire->cef); ?>][<?php echo e($date); ?>][]"
                                                    <?php echo e(in_array('8h30-11h00', $seances) ? 'checked' : ''); ?>></td>
                                            <td><input type="checkbox" value="11h00-13h30"
                                                    name="absences[<?php echo e($stagiaire->cef); ?>][<?php echo e($date); ?>][]"
                                                    <?php echo e(in_array('11h00-13h30', $seances) ? 'checked' : ''); ?>></td>
                                            <td><input type="checkbox" value="13h30-16h00"
                                                    name="absences[<?php echo e($stagiaire->cef); ?>][<?php echo e($date); ?>][]"
                                                    <?php echo e(in_array('13h30-16h00', $seances) ? 'checked' : ''); ?>></td>
                                            <td>
                                                <input type="checkbox" value="16h00-18h30"
                                                    name="absences[<?php echo e($stagiaire->cef); ?>][<?php echo e($date); ?>][]"
                                                    <?php echo e(in_array('16h00-18h30', $seances) ? 'checked' : ''); ?>>
                                            </td>
                                        <?php endfor; ?>

                                        <td class=""><?php echo e($stagiaire->cef); ?></td>
                                    </tr>
                            ...
                            <input type="hidden" name="start_date" value="<?php echo e(request('date')); ?>">
                            <input type="hidden" name="group_name" value="<?php echo e(request('groupe')); ?>">
                        </form>
...
<?php echo $__env->make('layout.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Desktop\DEV203\My_project_of_syntese\Gestion_Stagaiares\myApp\resources\views/listAbsences/index.blade.php ENDPATH**/ ?>